...
IOSX_FULL_STATIC_STRIPPED := $(BUILD_LIB)/lib$(IOSX_FULL_NAME).stripped.a
...
IOSX_STATIC := $(IOSX_LIB_STATIC) $(IOSX_STUB_STATIC) $(IOSX_FULL_STATIC) $(IOSX_FULL_STATIC_STRIPPED)
...
$(IOSX_FULL_STATIC_STRIPPED): $(IOSX_FULL_STATIC)
	strip -S -o $@ $^
