...
/* Call terminated */
typedef void (wcall_close_h)(int reason, const char *convid,
			   const char *userid, const char *metrics_json,
			     void *arg);
...
/* nat is of type enum mediaflow_nat
 */
 ...
 */
int wcall_start(const char *convid, int is_video_call /*bool*/);
