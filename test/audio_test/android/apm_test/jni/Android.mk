...
LOCAL_MODULE    := apm_test
LOCAL_CFLAGS    := -g -DHAVE_INTTYPES_H=1 -DPOSIX -DHAVE_WEBRTC \
		   -DWEBRTC_ANDROID -pthread
LOCAL_CXXFLAGS   := -g -DHAVE_INTTYPES_H=1 -DPOSIX -DHAVE_WEBRTC -x c++ -std=c++11 -stdlib=libc++ -DWEBRTC_ANDROID -pthread -DWEBRTC_POSIX

LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../../../mediaengine

LOCAL_SRC_FILES := ../../../src/apm_test.cpp
